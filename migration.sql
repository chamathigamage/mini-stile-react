...
ALTER TABLE users
ADD CONSTRAINT MIN_PASSWORD CHECK (CHAR_LENGTH(password) >= 1) CREATE TABLE lessons (
...
values ("all about dogs"),
  ...
  ("all about racoons"),
  ("all about birds"),
  ("all about bees") ("all about capybaras");
insert into images (image_url, description)
...
VALUES (3, 8),
  ...
  (8, 24);
insert into lessons (lesson_name)
values ("all about pandas");
insert into images (image_url, description)
values ("https://tinyurl.com/3wbn3f5u", "panda for card"),
  (
    "https://tinyurl.com/4rwrz363",
    "panda for lesson"
  ),
  ("images/bowtie.png", "bowtie for lesson");
insert into card_content (
...
values (
    9,
    "This lesson is about pandas. In this lesson you will learn about... what are pandas? what do pandas sound like? why are pandas so cute?",
    25,
    "For Students in <br /> Years 7-10",
    "all%20about%20pandas"
  );
insert into lesson_content (lesson_id, text_content)
VALUES (
    9,
    "in this lesson you must click to draw on a bow tie onto this very cute panda!"
  );
insert into img_content (lesson_id, image_id)
VALUES (9, 26),
  (9, 27);